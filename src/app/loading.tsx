export default function Loading(){
  ...
  return ( 
      <section className="flex items-center justify-between w-full max-w-[1246px] px-[15px] mx-auto"> 
        <section className="grid grid-cols-2 md:grid-cols-5 gap-6 container">
        {arr.map((_, index) => (
